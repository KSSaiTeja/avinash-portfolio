                ...
                <div className="container">
                    <div className="header-inner d-flex align-items-center">
                        ...
                        <div className="logo-outer">
                            <div className="logo">
                                <Link to="/" style={{fontSize: '28px', fontWeight: '700', color: '#007bff', textDecoration: 'none', letterSpacing: '2px'}}>AVINASH</Link>
                            </div>
                        </div>
                            ...
                            <nav className="main-menu navbar-expand-lg">
                                <div className="navbar-header">
                                    <div className="mobile-logo">
                                        <Link to="/" style={{fontSize: '24px', fontWeight: '700', color: '#007bff', textDecoration: 'none', letterSpacing: '2px'}}>AVINASH</Link>
                                    </div>
                                    {/* <!-- Toggle Button --> */}
